...
pub use consts::{
    ...
    KEEP_ALIVE_INTERVAL, MAX_FRAME_SIZE, MAX_SIGNAL_SIZE, MAX_UNJOINED_CODES_PER_CLIENT,
    MIN_USER_AGENT_LENGTH, SAFE_CHARSET, SESSION_CODE_LENGTH, SESSION_EXPIRATION_TIME,
    WS_PREFIX_KEEP_ALIVE, WS_PREFIX_SIGNAL_MESSAGE, WS_PREFIX_SYSTEM_ERROR, WS_PREFIX_SYSTEM_JOIN,
    WS_PREFIX_SYSTEM_MEMBERS, WS_PREFIX_SYSTEM_NAME, WS_PREFIX_SYSTEM_ROOMS,
